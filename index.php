  ...
  <div>
    <div class="container" style="max-width: 90%;">
      ...
      <div class="logistics" id="logistics">
        <div style="margin:0">
          <div class="row">
            ...
            <div class="col-md-12">
              <p>We offer logistics solutions to move your freight to its destination taking into consideration both costs and urgency tailored to your specific needs for each shipment.</p>
              <p>Whether it's a small carton shipped air freight, a pallet consigned via LCL or a full container load we can arrange shipping on your behalf or work with your nominated freight forwarder to move your goods to their destination as quickly as possible.</p>
              <p>Our email despatch advice with invoices ensures early customs clearance on arrival of goods. Online track and trace can assist those who purchase from us to plan the arrival of their orders.</p>
            </div>
            <div class="col-md-12">
              <div class="owl-clients owl-carousel">
                <div class="client-item">
      ...
      <div class="row" id="history">
        ...
        <div class="col-md-6 right-bordered">
          <div style="display:flex;align-items:center;height:100%;">
            <p style="text-align: right;">Our family owned company has continued to maintain close and personal contacts with our clients throughout the Asia Pacific Region since 1977. As one of the longest serving suppliers in this field we have pioneered the industry and continue to lead the way. Our highly skill team of people include those with years of service within this area, with technical expertise and knowledge of local conditions together with a young and enthusiastic support staff.</p>
          </div>
        </div>
        ...
        <div class="col-md-6" style="display: flex; flex-direction:column;justify-content:center">
          <div class="right-content">
            <div style="display:flex;justify-content:center;">
              <img src="/assets/images/values/pillars.jpg" style="max-height: 40vh;width:auto;" alt="Pillars" />
            </div>
          </div>
        </div>

        <div>
          <h4>Celebrating the people of Fastair...</h4>
          <p style="margin-bottom: 10px;">Our team here at Fastair have helped the company to succeed and continue to grow throughout this years. Here are a few sneak peak of our longest staff.</p>
          <div class="row">
      ...
      <div class="row" id="industries">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-lg-2 col-md-4 col-sm-4 industry">
      ...
      <div class="gallery" id="gallery">
        <div style="margin: 0;">
          <div class="row">
            ...
            <div class="my-gallery" id="gallery_inner" itemscope itemtype="http://schema.org/ImageGallery">
            </div>
